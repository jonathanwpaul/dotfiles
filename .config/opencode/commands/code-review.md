---
description: Two-axis review (Standards + Spec) of a branch diff since a fixed point
agent: plan
---
...
Both axes run as **parallel sub-agents** so they don't pollute each other's context, then this command aggregates their findings.
